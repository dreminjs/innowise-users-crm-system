...
const handleAddProfileSkillMock =
  jest.fn();
...
jest.mock(
  "@/modules/Skills/model/hooks/useAddProfileSkill",
  () => ({
    useAddProfileSkill:
      () => ({
        handleAddProfileSkill:
          handleAddProfileSkillMock.mockResolvedValue(
            undefined,
          ),
      }),
  }),
