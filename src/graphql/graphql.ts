...
export type GetCvsQuery = { cvs: Array<{ id: string, name: string, education: string | null, description: string, user: { id: string, email: string, profile: { first_name: string | null, last_name: string | null } } | null }> };
